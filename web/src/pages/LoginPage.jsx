      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="glass-card p-8">
          ...
          <div className="bg-accent/10 border border-accent/20 rounded-xl p-3 mb-6">
            <p className="text-accent text-xs font-medium mb-1">Demo Bilgileri</p>
            <p className="text-gray-300 text-xs">📧 admin@persona.com</p>
            <p className="text-gray-300 text-xs">🔑 admin123</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <Link to="/jobs" className="text-gray-400 text-sm hover:text-accent transition-colors">
              ← İş ilanlarına dön
            </Link>
          </div>
        </div>
